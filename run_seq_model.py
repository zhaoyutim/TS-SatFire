...
if __name__=='__main__':
    ...
    if test:
        model.load_weights(os.path.join('saved_models', 'af_'+model_name+'w' + str(1) + '_nopretrained'+'_run'+str(run)+'_'+str(num_heads)+'_'+str(mlp_dim)+'_'+str(hidden_size)+'_'+str(num_layers)+'_'+str(batch_size)+'_'+str(is_masked)+'way2'))
        f1_all = 0
        iou_all = 0
        ...
        model.save(os.path.join('saved_models', 'af_'+model_name+'w' + str(1) + '_nopretrained'+'_run'+str(run)+'_'+str(num_heads)+'_'+str(mlp_dim)+'_'+str(hidden_size)+'_'+str(num_layers)+'_'+str(batch_size)+'_'+str(is_masked)+'way2'))